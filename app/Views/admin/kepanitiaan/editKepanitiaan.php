        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form action="/update_kepanitiaan/<?= $Kepanitiaan['id_status_kepanitiaan'] ?>" method="post">
                        <div class="form-floating border-0 mb-3 text-tertiary ff-gantari">
                            <input type="text" class="form-control text-light" id="nama_kepanitiaan" name="nama_kepanitiaan" value="<?= $Kepanitiaan['nama_kepanitiaan'] ?>">
