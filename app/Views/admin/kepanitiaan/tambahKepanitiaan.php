        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form action="/simpan_kepanitiaan" method="post">
                        <div class="form-floating border-0 mb-3 text-tertiary ff-gantari">
                            <input type="text" class="form-control text-light" id="nama_kepanitiaan" name="nama_kepanitiaan">
                        ...
                        <div class="form-floating border-0 mb-3 text-tertiary ff-gantari">
                            ...
                            <label for="status_kepanitiaan">status_kepanitiaan</label>
                        </div>
