			...
			<div class="col-12">
				<div class="bg-secondary rounded h-100 p-4">
					...
					<table class="table table-hover table-responsive text-tertiary ff-gantari align-middle">
						...
						<?php foreach ($akun_bidang as $Bio) : ?>
						<tbody>
							<tr>
								<td><?= $Bio['id_akun_bidang'] ?></td>
								<td><?= $Bio['nama_bidang'] ?></td>
								<td><?= $Bio['username'] ?></td>
								<td>
									<div class="row row-cols-auto">
										<div class="col">
											<form action="/hapusAkunBidang/<?= $Bio['id_akun_bidang'] ?>" method="post">
										...
										<div class="col">
											<a class="btn btn-dark btn-sm ff-gantari"
												href="/editAkunBidang/<?= $Bio['id_akun_bidang'] ?>"><i class="fa fa-pen"></i></a>
										</div>
									</div>
								</td>
							</tr>
...
<!-- Back to Top -->
<a href="\tambahAkunBidang" class="btn btn-lg btn-light btn-lg-square back-to-top"><i class="bi bi-plus text-dark"></i></a>
